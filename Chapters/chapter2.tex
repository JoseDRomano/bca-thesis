...
\cite{perou2000molecular, eisen1998cluster}, where hierarchical clustering on gene
...
women with primary breast cancer (PBC) to identify clinically meaningful patient
...
oestrogen receptor (ER) levels, progesterone receptor (PgR) levels, pS2 protein levels,
...
the authors compared four clustering algorithms: K-Means \cite{hartigan1979kmeans},
self-organising maps (SOM) \cite{kohonen2001som}, hierarchical agglomerative clustering
(HAC) \cite{gordon1999classification}, and Gaussian mixture models (GMM)
\cite{scrucca2016mclust}; so as to assess whether the identified structure was robust
